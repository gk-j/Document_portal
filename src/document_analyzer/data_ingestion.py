...
class DocumentHandler:
    """
        ...
        Automatically logs all actions and supports sesion-based organization.
    """
...
if __name__=="__main__":
    ...
    pdf_path="/Users/gkj/Documents/llmops/document_portal/data/document_analysis/sample.pdf"
    ...
    handler = DocumentHandler(session_id="save_pdf")
    try:
